...
class JointActuatorHandle : public hardware_interface::JointStateHandle {
public:
  JointActuatorHandle() = default;

  JointActuatorHandle(const JointStateHandle& js, double* posDes, double* velDes, double* kp, double* kd, double* ff)
